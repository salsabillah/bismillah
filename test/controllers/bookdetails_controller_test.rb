...
class BookdetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bookdetail" do
    assert_difference('Bookdetail.count') do
      post bookdetails_url, params: { bookdetail: { amount: @bookdetail.amount, email: @bookdetail.email, name: @bookdetail.name } }
    end
  ...
  test "should update bookdetail" do
    patch bookdetail_url(@bookdetail), params: { bookdetail: { amount: @bookdetail.amount, email: @bookdetail.email, name: @bookdetail.name } }
